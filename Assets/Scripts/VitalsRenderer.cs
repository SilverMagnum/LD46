...
public class VitalsRenderer : MonoBehaviour {
...
/*
    ...
    public List<Vector3> points;   //position data
    public Queue<float> spawnTimes = new Queue<float>(); //list of spawn times, to simulate lifetime. Back of the queue is vertex 1, front of the queue is the end of the trail.
